 ...
 *
 */
nlsig(double& y, double& dy_dx, double x, const double xmax, const double xmin, double ymax, double ymin,
			const int n, const double lambda, const int safety, const unsigned char isreverse) {
